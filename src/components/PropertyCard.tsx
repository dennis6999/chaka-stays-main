...
const PropertyCard = ({
  ...
  return (
    <div className="flex flex-col h-full bg-transparent">
      ...
      <div className="relative aspect-video sm:aspect-[4/3] w-full overflow-hidden rounded-none sm:rounded-[1.5rem] bg-gray-100 shadow-sm group-hover:shadow-xl transition-all duration-500">
