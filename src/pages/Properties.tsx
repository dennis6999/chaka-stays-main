...
const Properties = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <div className="max-w-[1400px] mx-auto px-0 sm:px-8 lg:px-12 py-6 flex-grow">
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
          ...
          <div className="flex-1">
            ...
            <div className="lg:hidden sticky top-20 z-30 mx-0 px-4 py-3 bg-background/90 backdrop-blur-xl border-b border-border/40 shadow-sm mb-6 flex items-center justify-between gap-3">
